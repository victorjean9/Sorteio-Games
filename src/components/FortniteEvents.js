class FortniteEvents {
    ...
    mortesNoDrop = [
        ...
        { players: 2, weapons: 1, deaths: [2], text: `(Jogador1) e (Jogador2) caíram na mesma casa. Entretanto (Jogador1) encontrou uma (Arma1) primeiro e conseguiu eliminar (Jogador2).`},
        { players: 2, weapons: 1, deaths: [1], text: `(Jogador1) e (Jogador2) caíram na mesma casa. Entretanto (Jogador2) encontrou uma (Arma1) primeiro e conseguiu eliminar (Jogador1).`},
        { players: 2, weapons: 1, deaths: [2], text: `(Jogador1) e (Jogador2) caíram na mesmo baú. Entretanto (Jogador1) conseguiu pegar uma (Arma1) primeiro e eliminou (Jogador2).`},
        { players: 2, weapons: 1, deaths: [1], text: `(Jogador1) e (Jogador2) caíram na mesmo baú. Entretanto (Jogador2) conseguiu pegar uma (Arma1) primeiro e eliminou (Jogador1).`},
    ...
    mortes = [
        ...
        { players: 1, weapons: 0, deaths: [1], text: `(Jogador1) se eliminou sem querer ao cair de um local alto.`},
        { players: 2, weapons: 1, deaths: [2], text: `(Jogador1) encontra (Jogador2) e elimina (Jogador2) com sua (Arma1).`},
        { players: 2, weapons: 1, deaths: [1], text: `(Jogador1) encontra (Jogador2), inicia um confronto, mas (Jogador2) elimina (Jogador1) com sua (Arma1).`},
