...
const ColorfullWaves = (props) => {
    ...
    const Animate = (week) => {
        ...
        function init() {
            ...
            renderer = new THREE.WebGLRenderer({ canvas: canvas.current, antialias: true });
    ...
    return(
        <canvas ref={canvas} style={{display: display, width: '100%', height: '100%', position: 'fixed'}}></canvas>
    );
}

export default ColorfullWaves;